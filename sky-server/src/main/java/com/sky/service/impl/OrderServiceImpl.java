...
public class OrderServiceImpl implements OrderService {
    ...
    public PageResult pageQuery(Integer pageNum,Integer pageSize,Integer status) {
        ...
        if (page != null && page.getTotal() > 0){
            for (Orders orders : page) {
                ...
                BeanUtils.copyProperties(orders,orderVO);   // 拷贝了那些信息
    ...
    public OrderVO details(Long id) {
        ...
        OrderVO orderVO = new OrderVO();
        BeanUtils.copyProperties(orders,orderVO);   //  到底拷贝了什么？
    ...
    public void userCancelById(Long id) throws Exception {
        ...
        //  订单处于    待接单 状态下取消，需要进行退款
        if(ordersDB.getStatus().equals(Orders.TO_BE_CONFIRMED)){
            //  调用微信支付退款接口
            weChatPayUtil.refund(
                    ordersDB.getNumber(),   //  商家订单号
                    ordersDB.getNumber(),   //  商家退款单号
    ...
    public void reminder(Long id) {
        ...
        map.put("type",2);
        map.put("orderId",id);
        map.put("conntent","订单号：" + orders.getNumber());
